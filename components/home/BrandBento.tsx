...
export default function BrandBento() {
 ...
 <span className="text-xs font-bold tracking-[0.2em] text-hooke-500 mb-2 block">
 Filosofia
 </span>
 <h2 className="text-3xl md:text-4xl font-black text-hooke-900 tracking-tighter mb-4">
 O Padrão Hooke
 </h2>
 ...
 <h3 className="text-2xl font-black tracking-tight mb-2">Algodão Certificado BCI</h3>
 ...
 <h4 className="text-lg font-bold tracking-tight text-white mb-2">Exclusividade</h4>
