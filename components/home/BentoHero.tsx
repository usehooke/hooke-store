...
export default async function BentoHero() {
 ...
 <span className="inline-block mb-3 text-[10px] font-bold tracking-[0.2em] border border-white/30 px-2 py-1 backdrop-blur-sm">
 Destaque da Coleção
 </span>

 <h1 className="text-3xl md:text-5xl font-bold tracking-tight mb-4 leading-none">
 {mainProduct.name}
 </h1>
 ...
 <Link href={`/produto/${mainProduct.slug}`} className="group/link flex items-center gap-2 text-xs font-bold tracking-widest border-b border-white pb-1 hover:text-gray-300 hover:border-gray-300 transition-all">
 ...
 <span className="text-hooke-900 text-[10px] font-bold tracking-[0.2em] mb-2 block">
 Best Seller
 </span>
 <h3 className="text-2xl font-bold text-hooke-900 mb-4 leading-none tracking-tight max-w-[200px]">
 {secondaryProduct.name}
 </h3>
 <Link href={`/produto/${secondaryProduct.slug}`} className="inline-block bg-hooke-900 text-white px-6 py-3 text-[10px] font-bold tracking-widest hover:bg-hooke-700 transition-colors">
 Ver Oferta
 </Link>
 </div>
 </div>
 ...
 <Link href={`/produto/${tertiaryProduct.slug}`} className="text-[10px] font-bold tracking-widest border-b border-white/50 pb-0.5 hover:border-white transition-colors">
 Descobrir
 </Link>
 </div>
 </div>
