...
export default function CartSheet() {
 ...
 <h3 className="text-2xl font-black text-hooke-900 tracking-tighter mb-2">Quase lá!</h3>
 ...
 <label className="text-[10px] font-bold tracking-widest text-hooke-900">Seu Nome Completo</label>
 <input
 type="text"
 required
 value={customer.name}
 ...
 <div className="space-y-1">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900">Seu E-mail <span className="text-gray-400 font-normal lowercase tracking-normal">(opcional)</span></label>
 <input
 type="email"
 ...
 <div className="space-y-1">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900">Seu WhatsApp</label>
 <input
 type="tel"
 required
 ...
 Quero entrar para a <strong className="text-black ">Lista VIP</strong> e receber bastidores, ensaios e lançamentos exclusivos via WhatsApp.
 </label>
 </div>
 ...
 className="w-full mt-8 bg-black text-white px-6 py-4 flex items-center justify-center gap-2 rounded-none text-sm font-bold tracking-widest hover:bg-hooke-800 transition-colors disabled:opacity-50"
 >
 {isProcessing ? <Loader2 size={18} className="animate-spin" /> : <CreditCard size={18} />}
 {isProcessing ? 'GERANDO LINK...' : 'IR PARA O PAGAMENTO'}
 </button>
 <p className="text-center text-[10px] text-gray-400 mt-4 ">Pagamento seguro processado por Mercado Pago</p>
 </form>
 </div>
 </div>
 )}
 ...
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block mb-2">Simular Frete</label>
 ...
 onClick={calculateShipping}
 disabled={isCalculatingShipping || zipInput.length < 9}
 className="bg-hooke-900 text-white px-4 py-2 text-xs font-bold tracking-widest disabled:opacity-50 hover:bg-black transition-colors rounded-none whitespace-nowrap"
 >
 ...
 <span className="text-[10px] text-gray-500 ">Até {opt.prazo} dias úteis</span>
 </div>
 </div>
 ...
 {/* SESSÃO DE CUPOM */}
 <div className="border-t border-hooke-100 pt-4 mt-2">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block mb-2">Cupom de Desconto</label>
 {!appliedCoupon ? (
 <div>
 <div className="flex gap-2">
 <input
 ...
 <div className="flex justify-between text-base font-bold text-hooke-900 tracking-wider border-t border-hooke-100 pt-4 mt-2">
 <p>Subtotal</p>
 <p>{formatter.format(subtotal)}</p>
 </div>
 {promoDiscount > 0 && (
 <div className="flex justify-between text-base font-bold text-green-600 tracking-wider items-center">
 ...
 {couponDiscount > 0 && (
 <div className="flex justify-between text-base font-bold text-green-600 tracking-wider">
 <p>Cupom ({appliedCoupon})</p>
 <p>- {formatter.format(couponDiscount)}</p>
 </div>
 )}
 {shippingCost !== null && (
 <div className="flex justify-between text-base font-bold text-hooke-900 tracking-wider">
 ...
 <div className="flex justify-between text-xl font-black text-hooke-900 tracking-wider border-t border-hooke-100 pt-2 pb-2">
 <p>Total</p>
 ...
 className="w-full flex items-center justify-center gap-2 bg-hooke-900 text-white px-6 py-4 rounded-sm text-sm font-bold tracking-widest hover:bg-black transition-colors"
 >
 <CreditCard size={18} />
 COMPRAR AGORA
 </button>
 ...
 className="w-full flex items-center justify-center gap-2 bg-transparent text-green-700 border-2 border-green-600 px-6 py-3 rounded-sm text-sm font-bold tracking-widest hover:bg-green-50 transition-colors"
 >
