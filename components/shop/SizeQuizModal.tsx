      ...
      >
        ...
        <div className="bg-hooke-900 text-white p-6 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <Ruler size={20} />
            <h2 className="text-sm font-bold uppercase tracking-widest">Provador Virtual Hooke</h2>
          </div>
        ...
        <div className="p-8">
          <AnimatePresence mode="wait">
            ...
            {step === 1 && (
              ...
              >
                <div>
                  <h3 className="text-xl font-black uppercase tracking-tight text-hooke-900 mb-2">Sua Altura</h3>
                  <p className="text-xs text-gray-400 uppercase tracking-widest">Deslize para ajustar em cm</p>
                </div>
                ...
                <button 
                  onClick={() => setStep(2)}
                  className="w-full bg-hooke-900 text-white py-4 font-bold uppercase tracking-widest text-xs flex items-center justify-center gap-2 hover:bg-black transition-colors"
                >
            ...
            {step === 2 && (
              ...
              >
                <div>
                  <h3 className="text-xl font-black uppercase tracking-tight text-hooke-900 mb-2">Seu Peso</h3>
                  <p className="text-xs text-gray-400 uppercase tracking-widest">Aproxime o valor em kg</p>
                </div>
                ...
                <div className="flex gap-4">
                  <button onClick={() => setStep(1)} className="flex-1 border border-gray-200 py-4 font-bold uppercase tracking-widest text-[10px]">Voltar</button>
                  <button onClick={() => setStep(3)} className="flex-[2] bg-hooke-900 text-white py-4 font-bold uppercase tracking-widest text-xs">Continuar</button>
                </div>
              </motion.div>
            )}
            ...
            {step === 3 && (
              ...
              >
                <div>
                  <h3 className="text-xl font-black uppercase tracking-tight text-hooke-900 mb-2">Caimento</h3>
                  <p className="text-xs text-gray-400 uppercase tracking-widest">Como você gosta que a roupa fique?</p>
                </div>
                  ...
                  {[
                    ...
                    >
                      <div className="flex justify-between items-center">
                        <span className="font-bold uppercase tracking-widest text-xs text-hooke-900">{opt.label}</span>
                ...
                <button 
                  ...
                  className="w-full bg-hooke-900 text-white py-4 font-bold uppercase tracking-widest text-xs hover:bg-black transition-colors"
                >
                  Ver Resultado
                </button>
              </motion.div>
            ...
            {step === 4 && result && (
              ...
              >
                <div>
                  <p className="text-xs font-bold uppercase tracking-[0.2em] text-gray-400 mb-2">Recomendamos o tamanho</p>
                ...
                <div className="space-y-3">
                  ...
                  <button 
                    onClick={() => setStep(1)}
                    className="w-full text-xs font-bold uppercase tracking-widest text-gray-400 hover:text-hooke-900"
                  >
                    Refazer Teste
                  </button>
                </div>
