...
export default function ProductCard({ product }: ProductCardProps) {
 ...
 {product.featured && (
 <span className="bg-green-500 text-white text-[10px] font-bold px-2 py-1 tracking-widest shadow-lg animate-pulse rounded-sm">
 Destaque
 </span>
 )}
 </div>
 ...
 {/* Título */}
 <h3 className="text-white font-bold text-base leading-tight mb-1 drop-shadow-md truncate pr-4 tracking-wide transform transition-transform duration-500 group-hover:-translate-y-4">
 {product.name}
 </h3>
 ...
 <div className="w-full bg-white text-hooke-900 font-bold tracking-widest text-[11px] py-3 rounded-sm flex items-center justify-center gap-2 hover:bg-green-600 hover:text-white hover:scale-[1.02] active:scale-95 transition-all shadow-xl cursor-pointer">
 <ShoppingBag size={14} />
 EU QUERO
 </div>
 </div>
