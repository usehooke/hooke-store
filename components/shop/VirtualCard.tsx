...
export default function VirtualCard() {
 ...
 <span className="font-bold text-white ">{addr.name}:</span> {addr.street}, {addr.neighborhood}
 </p>
 </div>
 ))}
 </div>
 ...
 <span className="text-[10px] font-black tracking-widest text-black/40">Notas / Pedidos</span>
 ...
 <button 
 onClick={() => setIsFlipped(!isFlipped)}
 className="flex items-center gap-2 text-xs font-bold tracking-widest text-gray-500 hover:text-black transition-colors"
 >
 <RefreshCcw size={14} />
