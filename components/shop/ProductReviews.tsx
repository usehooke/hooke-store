    ...
    <div className="mt-24 border-t border-gray-100 pt-16 font-sans">
      <div className="flex flex-col md:flex-row justify-between items-start gap-12">
        <div className="max-w-xs">
          <h2 className="text-2xl font-black text-hooke-900 uppercase tracking-tight mb-4 leading-tight">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Baseado em 127 avaliações</p>
            </div>
          </div>
        ...
        <div className="flex-1 space-y-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      {review.verified && (
                        <div className="flex items-center gap-1 text-[8px] font-bold text-green-600 uppercase tracking-widest bg-green-50 px-1.5 py-0.5 rounded-full">
                          <CheckCircle2 size={8} />
                          Verificado
                        </div>
                      )}
          ...
          <button className="w-full md:w-auto mt-4 px-8 py-3 bg-gray-50 text-hooke-900 text-[10px] font-black uppercase tracking-widest hover:bg-hooke-100 transition-all border border-gray-100">
