...
export default function KitPromoCard({ product }: KitPromoCardProps) {
 ...
 <span className="bg-white/20 backdrop-blur-sm text-white text-[9px] font-bold px-2 py-0.5 tracking-wide">
 Tempo Limitado
 </span>
 </div>
 ...
 <div>
 <h4 className="text-lg font-black text-hooke-900 tracking-tight mb-1">
 ...
 <li className="flex items-center gap-3 text-xs text-hooke-700 font-bold tracking-wide">
 ...
 {/* Botão de Ação */}
 <button className="w-full bg-green-600 hover:bg-green-700 text-white font-bold tracking-widest text-xs py-4 flex items-center justify-center gap-2 transition-all group">
