...
export default function SmartSuggestions() {
 ...
 <h4 className="text-[10px] font-black tracking-[0.2em] text-hooke-900 italic">
 ...
 <p className="text-[10px] font-bold text-hooke-900 truncate">
 {product.name}
 </p>
 ...
 <p className="text-[9px] text-gray-400 mt-4 text-center tracking-widest leading-loose">
