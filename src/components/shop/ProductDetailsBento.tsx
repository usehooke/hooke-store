...
export default function ProductDetailsBento({ details }: BentoProps) {
 ...
 <span className="text-[9px] font-bold text-hooke-400 tracking-widest leading-none">Material</span>
 <Sparkles className="text-yellow-500 w-2.5 h-2.5" />
 </div>
 <h4 className="font-black text-hooke-900 tracking-tight text-sm leading-tight">{fabric}</h4>
 </div>
 </div>
 ...
 <h4 className="font-bold text-[10px] text-hooke-900 leading-tight">{model}</h4>
 </div>

 {/* 3. LAVAGEM (Compact) */}
 <div className="col-span-1 bg-gray-50/50 rounded-sm p-3 flex flex-col justify-center items-center text-center border border-transparent hover:border-gray-200 transition-all">
 <Droplets className="text-hooke-900 w-4 h-4 mb-2" />
 <h4 className="font-bold text-[10px] text-hooke-900 leading-tight">{wash}</h4>
 </div>
 ...
 <h4 className="font-black text-[10px] tracking-widest">Produção Ética • SP</h4>
 </div>
