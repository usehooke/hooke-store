import { BENEFICIOS_MARQUEE } from "@/config";
...
export default function BrandMarquee() {
 ...
 <div className="p-1.5 bg-white rounded-none shadow-sm group-hover:scale-110 transition-transform">
 <item.icon size={14} strokeWidth={2} className="text-hooke-900" />
 </div>
 <span className="text-xs font-bold tracking-widest text-hooke-800">
 {item.text}
 </span>
 </div>
 ))}
