...
export default function ShareButton({ title, text, url, className }: ShareButtonProps) {
 ...
 <button
 onClick={handleShare}
 className={`flex items-center gap-2 text-xs font-bold tracking-widest text-hooke-900 border border-gray-200 px-4 py-3 hover:bg-gray-50 transition-colors w-full sm:w-auto justify-center rounded-none ${className}`}
