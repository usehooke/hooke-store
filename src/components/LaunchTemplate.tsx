...
export default function LaunchTemplate({ product }: LaunchTemplateProps) {
 ...
 <span className="inline-block px-3 py-1 bg-black text-white text-[10px] tracking-[0.3em] font-bold mb-6">
 Lançamento Hooke
 </span>
 ...
 <Link 
 href={`#comprar`}
 className="px-10 py-5 bg-black text-white text-[11px] font-bold tracking-widest hover:bg-zinc-800 transition-all transform hover:-translate-y-1 text-center"
 >
 GARANTIR O MEU AGORA
 </Link>
 <div className="flex items-center gap-3 px-6 py-4">
 <span className="text-xl font-black">{formatarMoeda(product.price)}</span>
 <span className="text-[10px] text-zinc-400 tracking-widest leading-none">Em até 3x <br/>Sem juros</span>
 </div>
 </div>
 </div>
 </div>
 ...
 <div>
 <h2 className="text-xs font-bold tracking-[0.4em] text-zinc-400 mb-2">Editorial Series</h2>
 ...
 <p className="text-[10px] tracking-widest font-bold">01 — Perfil Completo</p>
 </div>
 </div>
 ...
 />
 <div className="absolute bottom-6 left-6 text-white mix-blend-difference">
 <p className="text-[10px] tracking-widest font-bold">02 — Detalhes do Rosto & Gola</p>
 </div>
 </div>
 ...
 />
 <div className="absolute bottom-6 left-6 text-white mix-blend-difference">
 <p className="text-[10px] tracking-widest font-bold">03 — Caimento das Costas</p>
 </div>
 </div>
 ...
 <p className="text-white/80 text-sm font-light leading-relaxed max-w-xs tracking-widest">
 Um olhar aproximado sobre a trama do tecido. Onde a engenharia têxtil encontra a excelência estética.
 </p>
 </div>
 <div className="absolute top-6 right-6 z-10">
 <span className="px-4 py-2 border border-white/30 text-white text-[10px] tracking-widest font-bold backdrop-blur-md">
 Detalhe Têxtil
 </span>
 </div>
 </div>
 ...
 <p className="text-white/50 text-sm max-w-xs mt-8 md:mt-0 font-light tracking-wide leading-relaxed ">
 ...
 <span className="text-white/40 text-[10px] tracking-[0.3em] font-bold">Catalog Plate / 00{i+1}</span>
 </div>
 ))}
 </div>
 </section>
 ...
 <span className="text-[10px] font-bold tracking-widest">Suedine 240g</span>
 </div>
 <div className="flex flex-col items-center">
 <Wind className="mb-4 text-zinc-300" strokeWidth={1} size={32}/>
 <span className="text-[10px] font-bold tracking-widest">Respirável</span>
 </div>
 <div className="flex flex-col items-center">
 <Ruler className="mb-4 text-zinc-300" strokeWidth={1} size={32}/>
 <span className="text-[10px] font-bold tracking-widest">Corte Boxy</span>
 </div>
 </div>
 </div>
 ...
 <span className="text-zinc-400 text-[10px] tracking-[0.3em] mb-2 block">Destaque de Lançamento</span>
 <h3 className="text-4xl font-bold tracking-tight mb-4 ">{product.name}</h3>
 <p className="text-zinc-500 text-sm mb-8 leading-relaxed">
 {product.description}
 </p>
 <div className="mb-10">
 <span className="text-4xl font-black block">{formatarMoeda(product.price)}</span>
 <span className="text-zinc-400 text-[10px] font-bold tracking-widest">ou 3x de {formatarMoeda(product.price/3)} s/ juros</span>
 </div>
 <Link 
 href={`/produto/${product.slug}`}
 className="block w-full py-6 bg-black text-white text-[12px] font-bold tracking-[0.2em] hover:bg-zinc-800 transition-all text-center"
 >
 FINALIZAR PEDIDO AGORA
 </Link>
 <p className="text-center text-[10px] text-zinc-400 mt-6 tracking-widest flex items-center justify-center gap-2">
 ...
 <p className="text-zinc-300 text-[10px] font-bold tracking-[1em]">HOOKE STORE © 2024</p>
 </footer>
 </div>
 );
}
