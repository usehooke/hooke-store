...
export default function AboutPage() {
 ...
 <Image
 src="/lookbook/HK_ELITE_FOUNDER_CAFE_V2.png"
 alt="Founder Hooke - Cafe Lifestyle Elite V2"
 fill
 ...
 <span className="text-xs font-bold tracking-[0.2em] text-gray-400 mb-6 block font-sans">
 Desde 2006
 </span>

 <h1 className="text-4xl md:text-6xl font-black text-hooke-900 tracking-tighter leading-[0.9] mb-8 font-sans">
 ...
 <p className="text-xs font-bold tracking-widest text-hooke-900 font-sans">
 Fernando Luiz Ferreira Jr.
 </p>
 <p className="text-[10px] text-gray-400 tracking-widest font-sans">
 Fundador & CEO
 </p>
 </div>
 ...
 <h2 className="text-3xl md:text-5xl font-black tracking-tighter mb-8 font-sans">
 &quot;O detalhe é o que separa o comum do extraordinário.&quot;
 </h2>
 <Link href="/colecao" className="inline-flex items-center gap-3 border-b border-white pb-1 text-xs font-bold tracking-widest hover:text-gray-300 hover:border-gray-300 transition-all font-sans">
