...
export default async function LandingPage({ params }: LPPageProps) {
 ...
 <div>
 <h3 className="text-sm font-black tracking-widest mb-2">{f.title}</h3>
 <p className="text-xs text-gray-400 leading-relaxed font-bold tracking-tight">{f.desc}</p>
 </div>
 </div>
 );
 })}
 ...
 <h2 className="text-4xl md:text-5xl font-black tracking-tighter text-hooke-900 mb-4">Escolha sua Armadura</h2>
 <p className="text-[10px] text-gray-400 font-black tracking-[0.4em] ml-1">Lançamento Limitado • 2026 Season</p>
 </div>
 ...
 <p className="text-gray-400 font-bold tracking-widest">Nenhum produto encontrado nesta categoria no momento.</p>
 </div>
 )}
 </div>
 </section>
 ...
 <h2 className="text-4xl font-black tracking-tighter mb-6">Pronto para elevar o nível?</h2>
 <p className="text-xs text-hooke-300 tracking-[0.3em] mb-12">Entre para o time Hooke Store.</p>
 <Link 
 href="/" 
 className="bg-white text-hooke-900 px-12 py-5 text-xs font-black tracking-[0.2em] hover:bg-gray-100 transition-all inline-block"
 >
