...
interface WaferEliteClientProps {
    productData: ProductData;
}

export default function WaferEliteClient({ productData }: WaferEliteClientProps) {
    const { trackAction, pendingCount } = useOfflineSync();

    const handleAddToCart = () => {
        trackAction('ADD_TO_CART', productData.id);
            ...
            <section className="px-8 -mt-12 relative z-10">
                ...
                >
                    ...
                    <div className="flex items-center gap-4 mb-6">
                        <span className="text-xl font-medium tracking-tight">R$ {productData.price.toFixed(2)}</span>
                    ...
                    <button 
                        ...
                        className="w-full bg-black text-white py-5 flex items-center justify-center gap-3 neumorph-btn shadow-neumorph-dark active:shadow-neumorph-pressed group cursor-pointer"
                    >
