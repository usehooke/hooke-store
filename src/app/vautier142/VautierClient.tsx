...
export default function VautierClient() {
            ...
            >
                ...
                <div className="w-full px-12 py-16 text-center space-y-12 relative z-10 bg-white border-t border-black/5">
                    ...
                    <button 
                        ...
                        disabled={isLoading}
                        className="group w-full max-w-md mx-auto relative flex items-center justify-between p-10 bg-black text-white active:scale-[0.98] transition-all shadow-sharp border border-black cursor-pointer"
                    >
