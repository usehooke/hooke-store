...
export default function PoliticaDeTrocas() {
 ...
 <span className="text-hooke-500 text-xs font-bold tracking-widest mb-2 block">Institucional</span>
 <h1 className="text-4xl md:text-5xl font-black text-hooke-900 tracking-tighter">Trocas e Devoluções</h1>
 </div>
 ...
 <h3 className="text-xl font-bold tracking-tighter text-hooke-900 mt-8 mb-4">A Primeira Troca é Grátis</h3>
 <p>
 ...
 <h3 className="text-xl font-bold tracking-tighter text-hooke-900 mt-8 mb-4">Prazos</h3>
 ...
 <h3 className="text-xl font-bold tracking-tighter text-hooke-900 mt-8 mb-4">Condições das Peças</h3>
 <p>
