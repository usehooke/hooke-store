...
export default function BarcodeLabel({ sku, name, size }: BarcodeLabelProps) {
 ...
 <h3 className="text-[12px] font-black tracking-tighter leading-none mb-1">Hooke</h3>
 <p className="text-[8px] font-bold truncate leading-none opacity-70">{name}</p>
 </div>
 ...
 <span className="text-[6px] font-black opacity-50 leading-none">TAM</span>
 <span className="text-[12px] font-black leading-none">{size}</span>
 </div>
 <div className="flex flex-col items-end">
 <span className="text-[6px] font-black opacity-30 leading-none italic">Elite SKU</span>
 </div>
 </div>
 </div>
 );
