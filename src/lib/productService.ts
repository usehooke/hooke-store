...
export async function getProducts(category?: string): Promise<Product[]> {
    ...
    try {
        ...
        console.warn("⚠️ [ProductService] Falha em getProducts:", error);
        return [];
    }
}
...
export async function getProductBySlug(slug: string): Promise<Product | null> {
    ...
    try {
        ...
        console.warn("⚠️ [ProductService] Falha em getProductBySlug:", error);
        return null;
    }
}
...
export async function getProductsByModelId(modelId: string): Promise<Product[]> {
    ...
    try {
        ...
        console.warn("⚠️ [ProductService] Falha em getProductsByModelId:", error);
        return [];
    }
}
...
export async function getFeaturedProducts(limitCount: number = 8): Promise<Product[]> {
    ...
    try {
        ...
        console.warn("⚠️ [ProductService] Falha em getFeaturedProducts:", error);
        return [];
    }
}
...
export async function getFilteredProducts(filters: FilterOptions): Promise<Product[]> {
    ...
    try {
        ...
        console.warn("⚠️ [ProductService] Falha em getFilteredProducts:", error);
        return [];
    }
}
