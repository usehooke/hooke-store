...
export default function ContactPage() {
 ...
 target="_blank"
 className="inline-flex w-full items-center justify-center gap-2 bg-green-600 text-white px-6 py-4 text-xs font-bold tracking-widest hover:bg-green-700 transition-colors shadow-sm"
 >
 Iniciar Conversa
 </Link>
 </div>
 ...
 <Mail size={18} />
 <h4 className="text-xs font-bold tracking-widest">E-mail</h4>
 </div>
 ...
 <div className="flex items-center gap-2 mb-2 text-hooke-900">
 <Clock size={18} />
 <h4 className="text-xs font-bold tracking-widest">Horário</h4>
 </div>
 ...
 <h3 className="text-2xl font-black tracking-tight mb-2">Loja Física</h3>
 ...
 target="_blank"
 className="text-xs font-bold tracking-widest border-b border-white pb-1 inline-block hover:text-gray-300 hover:border-gray-300 transition-colors"
 >
 Ver no Mapa
 </Link>
 </div>
 ...
 <div className="bg-white p-8 border border-gray-100">
 <h3 className="text-xs font-bold tracking-widest mb-3">Qual o prazo de entrega?</h3>
 <p className="text-sm text-gray-500 leading-relaxed">
 Enviamos em até 24h úteis após a confirmação. Para SP capital, chega no dia seguinte via Sedex.
 </p>
 </div>
 <div className="bg-white p-8 border border-gray-100">
 <h3 className="text-xs font-bold tracking-widest mb-3">Como funciona a troca?</h3>
 <p className="text-sm text-gray-500 leading-relaxed">
 A primeira troca é por nossa conta. Você tem 7 dias após o recebimento para solicitar.
 </p>
 </div>
 <div className="bg-white p-8 border border-gray-100">
 <h3 className="text-xs font-bold tracking-widest mb-3">Vendem no Atacado?</h3>
 <p className="text-sm text-gray-500 leading-relaxed">
