  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="w-full px-6 py-8 border-b border-gray-100 flex items-center justify-between">
        <Link 
          href="/" 
          className="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-hooke-900 hover:opacity-60 transition-opacity"
        >
          <ChevronLeft size={16} /> Voltar ao Shop
        </Link>
        <span className="text-[10px] font-black uppercase tracking-tighter text-gray-300">Hooke Virtual Card</span>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12 md:py-20 lg:grid lg:grid-cols-2 lg:gap-16 items-center">
        ...
        <div className="mb-12 lg:mb-0 print:m-0 print:p-0">
          <VirtualCard />
          <p className="text-center text-[10px] text-gray-400 mt-4 uppercase tracking-widest animate-pulse print:hidden">
        ...
        <div className="space-y-10 print:hidden">
          <div className="space-y-4">
            <h1 className="text-4xl md:text-5xl font-black text-hooke-900 uppercase tracking-tighter leading-none">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-1">
            ...
            <button 
              ...
              className="group relative flex items-center justify-center gap-3 bg-black text-white px-8 py-5 text-xs font-bold uppercase tracking-widest hover:bg-zinc-900 transition-all disabled:opacity-50"
            >
              {isExporting ? (
            ...
            <button 
              onClick={handleShare}
              className="flex items-center justify-center gap-3 border-2 border-black text-black px-8 py-5 text-xs font-bold uppercase tracking-widest hover:bg-black hover:text-white transition-all shadow-sm"
            >
            ...
            <button 
              onClick={handlePrint}
              className="flex items-center justify-center gap-3 text-xs font-bold uppercase tracking-widest text-gray-400 hover:text-black transition-colors"
            >
          ...
          <div className="pt-8 border-t border-gray-100 grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div>
              <h4 className="text-[10px] font-black uppercase tracking-widest text-hooke-900 mb-2">Lojas Físicas</h4>
            ...
            <div>
              <h4 className="text-[10px] font-black uppercase tracking-widest text-hooke-900 mb-2">Suporte Direto</h4>
