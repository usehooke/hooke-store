...
export default function PersonalHookePage() {
 ...
 <p className="text-[9px] text-white/30 tracking-[0.2em] mt-1 font-bold">Command Center</p>
 </div>
 <button 
 onClick={() => setIsSidebarOpen(false)}
 ...
 <p className="text-[10px] text-white/40 tracking-widest font-bold">Resumo da Semana</p>
 </div>
 ...
 <span className="text-[10px] text-white/30 font-bold">Treinos</span>
 </div>
 <button 
 onClick={handleFinishWorkout}
 className="text-[9px] bg-white/10 hover:bg-white/20 px-3 py-1.5 rounded-lg border border-white/5 transition-colors font-bold tracking-tighter flex items-center gap-1.5"
 >
 ...
 <p className="text-[10px] text-white/20 tracking-widest pl-1">Atalhos de Sistema</p>
 ...
 <span className="font-bold text-[10px] text-white/70 group-hover:text-white leading-tight">{item.label}</span>
 </Link>
 ))}
 </div>
 </div>
 ...
 {/* Seção Ferramentas */}
 <div className="space-y-3">
 <p className="text-[10px] text-white/20 tracking-widest pl-1">Assistente</p>
 <button
 onClick={handleRestart}
 ...
 className="text-white/40 font-bold tracking-[0.4em] text-[10px]"
 >
 Configurando Treino...
 </motion.p>
 </motion.div>
