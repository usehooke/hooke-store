...
export default function GuiaMedidas() {
 ...
 {/* OVERSZIED */}
 <div>
 <h2 className="text-2xl font-bold tracking-tighter text-hooke-900 mb-6 border-l-4 border-hooke-900 pl-4">Camisetas Oversized</h2>
 ...
 <thead>
 <tr className="bg-hooke-900 text-white text-xs tracking-widest font-bold">
 ...
 {/* REGATAS E VINTAGE */}
 <div>
 <h2 className="text-2xl font-bold tracking-tighter text-hooke-900 mb-6 border-l-4 border-hooke-900 pl-4">Regatas e Camisetas Regular</h2>
