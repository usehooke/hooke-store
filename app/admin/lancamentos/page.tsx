    ...
    <div className="min-h-screen bg-white font-sans p-6 md:p-12">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6 pb-8 border-b border-zinc-100">
          <div>
            <Link href="/admin" className="flex items-center gap-2 text-zinc-400 hover:text-black transition-colors text-xs font-bold uppercase tracking-widest mb-4">
              <ArrowLeft size={14} /> Voltar ao Painel
            </Link>
            <h1 className="text-4xl font-black tracking-tighter uppercase">Gestão de Lançamentos</h1>
          ...
          <div className="flex gap-4">
            <a 
              ...
              target="_blank" 
              className="flex items-center gap-2 px-6 py-4 bg-zinc-100 text-black text-[10px] font-bold uppercase tracking-widest hover:bg-zinc-200 transition-all shadow-sm"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-zinc-50 p-8 border border-zinc-100 relative overflow-hidden group">
            ...
            <h3 className="text-sm font-bold uppercase tracking-widest mb-4">Cadastre no Catálogo</h3>
            <p className="text-xs text-zinc-500 leading-relaxed">
          ...
          <div className="bg-zinc-50 p-8 border border-zinc-100 relative overflow-hidden group">
            ...
            <h3 className="text-sm font-bold uppercase tracking-widest mb-4">Divulgue o Link</h3>
            <p className="text-xs text-zinc-500 leading-relaxed">
        ...
        <div className="bg-white">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h2 className="text-xl font-bold uppercase tracking-[0.2em]">Lançamentos Ativos</h2>
          </div>
            ...
            {lancamentos.length > 0 ? lancamentos.map(p => (
              <div key={p.id} className="border border-zinc-100 p-6 flex flex-col md:flex-row items-center gap-6 group hover:border-black transition-all">
                ...
                <div className="flex-grow text-center md:text-left">
                  ...
                  <h3 className="text-lg font-black uppercase tracking-tight mb-4">{p.name}</h3>
                  <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                    <Link 
                      href={`/lancamento/${p.slug}`}
                      target="_blank"
                      className="inline-flex items-center gap-2 px-4 py-2 border border-black text-[10px] font-bold uppercase tracking-widest hover:bg-black hover:text-white transition-all"
                    >
                    ...
                    <Link 
                      href={`/produto/${p.slug}`}
                      target="_blank"
                      className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-100 text-zinc-500 text-[10px] font-bold uppercase tracking-widest hover:bg-zinc-200 transition-all"
                    >
                      Página da Loja
                    </Link>
                  </div>
              ...
              <div className="col-span-2 py-20 border border-dashed border-zinc-200 text-center">
                 <p className="text-zinc-400 text-xs font-bold uppercase tracking-widest">Nenhum lançamento ativo no momento.</p>
