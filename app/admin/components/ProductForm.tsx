...
export default function ProductForm({ initialData, onSubmit, onCancel, isSaving }: ProductFormProps) {
 ...
 const colorSiglaFound = Object.entries(COLOR_DICTIONARY).find(([ , info]) => info.label.toLowerCase() === c.name.toLowerCase());
 const colorSigla = colorSiglaFound ? colorSiglaFound[0] as ColorSigla : c.name.substring(0, 3).toUpperCase() as ColorSigla;
 ...
 <h2 className="text-2xl font-black tracking-tighter text-hooke-900">
 {initialData ? "Editar Produto" : "Criar Novo Produto Pro"}
 </h2>
 <span className="text-xs bg-hooke-900 text-white px-3 py-1 font-bold tracking-widest ">V4.0 Panel</span>
 </div>
 ...
 <h3 className="text-sm font-black tracking-widest text-hooke-900 border-b border-gray-200 pb-2 flex justify-between">
 ...
 <h3 className="text-sm font-black tracking-widest text-hooke-900 border-b border-gray-200 pb-2">
 ...
 <span className="text-xs font-bold tracking-widest">{color.name}</span>
 </div>
 ...
 className="text-[10px] bg-hooke-900 text-white p-2 font-bold tracking-widest mt-1 hover:bg-black transition-colors"
 >
 Adicionar Cor
 </button>
 </div>
 ...
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block">Descrição para o Google (Alt Text)</label>
 <input
 type="text"
 value={seoAltText}
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block">Meta Description (Google)</label>
 <textarea
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block">Nome do Produto *</label>
 <input
 type="text"
 required
 value={name}
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block">Preço (R$) *</label>
 <input
 type="number"
 required
 step="0.01"
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block">Preço Combo (3+) R$</label>
 <input
 type="number"
 step="0.01"
 value={comboPrice || ""}
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block">Categoria *</label>
 <select
 value={category}
 ...
 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div className="space-y-2">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block">Modelagem Hooke 2026 *</label>
 <select
 value={modelSigla}
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block">Estampa / Tecido Hooke 2026 *</label>
 <select
 value={printSigla}
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block">Peso Estimado (g)</label>
 <input
 type="number"
 value={weight}
 ...
 placeholder="Ex: 300"
 />
 <p className="text-[9px] text-gray-400 mt-1 font-bold">O peso é ajustado automaticamente baseado no tecido, mas pode ser alterado manualmente.</p>
 </div>

 <div className="space-y-2 bg-white flex flex-col pt-2 pb-6 z-10 relative">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block">Descrição Rica (Estilo, Composição, Gramatura) *</label>
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block mb-3">Tamanhos Disponíveis</label>
 ...
 <h3 className="text-sm font-black tracking-widest text-hooke-900">
 ...
 <span className="text-[9px] tracking-wider text-gray-400 font-bold mb-1">SKU</span>
 <input
 type="text"
 ...
 onFocus={() => {
 if (!skus[comboKey]) {
 const colorSiglaFound = Object.entries(COLOR_DICTIONARY).find(([ , info]) => info.label.toLowerCase() === color.name.toLowerCase());
 const colorSigla = colorSiglaFound ? colorSiglaFound[0] as ColorSigla : color.name.substring(0, 3).toUpperCase() as ColorSigla;
 ...
 <div className="flex flex-col">
 <span className="text-[9px] tracking-wider text-gray-400 font-bold mb-1">QTD</span>
 <input
 type="number"
 placeholder="Qtd"
 ...
 />
 <label htmlFor="featuredCheckbox" className="text-xs font-bold tracking-widest cursor-pointer">Destacar na Home</label>
 </div>
 <div className="flex items-center gap-2">
 <input
 type="checkbox"
 ...
 className="w-4 h-4 text-hooke-900 focus:ring-hooke-900"
 />
 <label htmlFor="activeCheckbox" className="text-xs font-bold tracking-widest cursor-pointer">Ativo (Visível)</label>
 </div>
 </div>
 ...
 type="button"
 onClick={onCancel}
 className="px-6 py-3 font-bold tracking-widest text-xs border border-hooke-900 text-hooke-900 hover:bg-gray-100 transition-colors"
 >
 Cancelar
 </button>
 <button
 type="submit"
 disabled={isSaving}
 className="px-8 py-3 font-bold tracking-widest text-xs bg-hooke-900 text-white hover:bg-black transition-colors disabled:opacity-50"
 >
