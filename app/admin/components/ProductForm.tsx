...
export default function ProductForm({ initialData, onSubmit, onCancel, isSaving }: ProductFormProps) {
    ...
    // SEO
    const [altText, setAltText] = useState(initialData?.seo?.altText || "");
                ...
                <div className="lg:col-span-4 space-y-8">
                    ...
                    <div className="space-y-4 pt-6 border-t border-gray-200">
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-hooke-900 block">Alt Text das Imagens</label>
                            <input
                                type="text"
                                value={altText}
                                ...
                                placeholder="Ex: Homem vestindo camiseta oversized preta em fundo branco"
                            />
                        </div>
