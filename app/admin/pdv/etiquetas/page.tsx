...
export default function LabelGeneratorPage() {
 ...
 <button 
 className="w-full bg-hooke-900 text-white p-6 font-black tracking-widest flex items-center justify-center gap-3 shadow-neumorph active:scale-95 transition-all"
