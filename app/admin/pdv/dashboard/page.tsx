      ...
      <div className="max-w-7xl mx-auto">
        <header className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-black tracking-tighter uppercase">Fechamento de Caixa</h1>
          </div>
          <div className="text-xs font-bold text-hooke-500 uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-hooke-50 p-6 shadow-neumorph text-center">
            ...
            <p className="text-[10px] font-bold text-hooke-500 uppercase mb-1">Total Vendido</p>
          ...
          <div className="bg-hooke-50 p-6 shadow-neumorph text-center">
            ...
            <p className="text-[10px] font-bold text-hooke-500 uppercase mb-1">Vendas PDV</p>
          ...
          <div className="bg-hooke-50 p-6 shadow-neumorph text-center">
            ...
            <p className="text-[10px] font-bold text-hooke-500 uppercase mb-1">Itens Saídos</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="bg-hooke-50 p-8 shadow-neumorph">
            <h3 className="text-sm font-black uppercase tracking-widest mb-6">Mix de Vendas: Físico vs Online</h3>
            <div className="h-64">
          ...
          {/* Top Items Chart */}
          <div className="bg-hooke-50 p-8 shadow-neumorph">
            <h3 className="text-sm font-black uppercase tracking-widest mb-6">Top Itens do Dia</h3>
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
