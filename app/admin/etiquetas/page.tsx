    ...
    return (
        <div className="p-8">
            <div className="flex justify-between items-end mb-8 print:hidden">
                <div>
                    <h1 className="text-3xl font-black text-hooke-900 uppercase tracking-tighter">Gerador de Etiquetas</h1>
                ...
                <button
                    ...
                    className="flex items-center gap-2 bg-hooke-900 text-white px-6 py-3 font-bold uppercase tracking-widest text-sm hover:bg-black transition-colors disabled:opacity-50"
                >
                    <Printer size={18} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 print:hidden">
                ...
                <div className="lg:col-span-4">
                    <div className="bg-gray-50 border border-hooke-900 p-6 sticky top-8">
                        <h3 className="font-black text-hooke-900 tracking-widest uppercase text-sm border-b border-gray-200 pb-3 mb-4">
                            Fila de Impressão
                        </h3>
                        ...
                        {hasSelected && (
                            <button
                                ...
                                className="w-full mt-6 py-2 text-xs font-bold uppercase tracking-widest text-gray-500 hover:text-black transition-colors"
                            >
                                Limpar Fila
                            </button>
                        )}
                    ...
                    {Object.entries(selectedSkus).flatMap(([sku, qty]) => {
                        ...
                        return Array(qty).fill(sku).map((s, index) => (
                            <div key={`${s}-${index}`} className="flex flex-col items-center justify-center border border-dashed border-gray-300 p-4" style={{ height: '38.1mm', width: '63.5mm' }}>
                                ...
                                />
                                <span className="text-[8px] mt-1 font-bold text-black uppercase tracking-widest">Hooke Store</span>
                            </div>
                        ));
                    })}
                </div>
