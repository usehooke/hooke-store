...
function ProductView({ product }: { product: Product }) {
 ...
 <span className="bg-hooke-100 text-hooke-900 text-[9px] font-bold tracking-widest px-2 py-0.5 inline-flex items-center gap-1 font-outfit border border-hooke-200">
 Qualidade Premium
 </span>
 )}
 </div>
 ...
 <span className="text-[9px] font-bold text-hooke-900 tracking-widest">
