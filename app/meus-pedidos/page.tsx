...
function MyOrdersContent() {
 ...
 <div className="mb-8">
 <Link href="/" className="inline-flex items-center text-xs font-bold tracking-widest text-hooke-500 hover:text-black transition-colors">
 <ChevronLeft size={16} className="mr-1" />
 Voltar à Loja
 </Link>
 <h1 className="text-4xl font-black tracking-tighter text-hooke-900 mt-4">Meus Pedidos</h1>
 ...
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block mb-2">E-mail de Compra</label>
 <input
 type="email"
 value={email}
 ...
 <div className="w-full">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block mb-2">Seu WhatsApp</label>
 <input
 type="tel"
 value={phone}
 ...
 <div className="w-full">
 <label className="text-[10px] font-bold tracking-widest text-hooke-900 block mb-2">ID do Pedido</label>
 <input
 type="text"
 value={orderId}
 ...
 type="submit"
 disabled={loading}
 className="w-full sm:w-auto h-[46px] bg-hooke-900 text-white px-8 flex items-center justify-center font-bold tracking-widest text-xs hover:bg-black transition-colors disabled:opacity-70 disabled:cursor-not-allowed"
 >
 ...
 <div>
 <p className="text-[10px] tracking-widest opacity-70 mb-1">Pedido</p>
 <p className="font-mono text-sm sm:text-base">{order.id}</p>
 </div>
 <div className="text-left sm:text-right">
 <p className="text-[10px] tracking-widest opacity-70 mb-1">Status Atual</p>
 <div className="inline-flex items-center bg-white text-hooke-900 px-4 py-1 font-bold text-xs tracking-widest">
 ...
 {/* Cliente */}
 <div>
 <h3 className="text-xs font-bold tracking-widest text-hooke-900 mb-4 border-l-2 border-hooke-900 pl-3">Dados do Cliente</h3>
 ...
 {/* Entrega */}
 <div>
 <h3 className="text-xs font-bold tracking-widest text-hooke-900 mb-4 border-l-2 border-hooke-900 pl-3">Entrega</h3>
 ...
 <p className="text-[10px] font-bold tracking-widest text-green-800 mb-1">Código de Rastreio dos Correios</p>
 ...
 {/* Pagamento */}
 <div>
 <h3 className="text-xs font-bold tracking-widest text-hooke-900 mb-4 border-l-2 border-hooke-900 pl-3">Pagamento</h3>
 ...
 {/* Itens */}
 <div>
 <h3 className="text-xs font-bold tracking-widest text-hooke-900 mb-6">Resumo da Compra</h3>
 ...
 <p className="text-sm font-bold text-gray-500 tracking-widest">Total Gasto</p>
...
export default function MyOrdersPage() {
 ...
 <p className="text-xs font-bold text-hooke-900 tracking-widest">Carregando painel...</p>
 </div>
 }>
 <MyOrdersContent />
 </Suspense>
